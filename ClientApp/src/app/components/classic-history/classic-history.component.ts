...
export class ClassicHistoryComponent {
  ...
  getTransactionInfo(chassisNo: string, txId: string) {
    this.router.navigate(['/transaction/'+chassisNo+'/'+txId]);
  }
  ...
  openPopup(chassisNo: string, txn: string) {
    this.displayStyle = "block";
    this.http.get<Transaction>(this.baseUrl+'api/Transaction/' + chassisNo+'/'+txn, Token.getHeader()).subscribe(result => {
