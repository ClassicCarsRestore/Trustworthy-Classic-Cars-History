...
const appRoutes: Routes = [
  ...
  { path: 'classics', component: OwnerClassicsComponent, canActivate: [AuthGuard] },
  { path: 'classics/details/:chassisNo', component: ClassicDetailsComponent, canActivate: [AuthGuard]},
  ...
  { path: 'transaction/:chassisNo/:txId', component: TransactionInfoComponent },
];
